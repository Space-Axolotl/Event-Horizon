...
## Recon Officer
Responsible for managing sensors, special equipment, and magical aid in battle, the Recon Officer is an important role in any ship engagement. As a Science Officer, you can take the following actions in ship combat: 
...
**_Activate Special Systems_:** You may use your action to activate any special systems the ship has, such a cloaking device. 
...
## Comms Officer
The Communications Officer is the crew's coordinator responsible for relying relevant data to ensure optimal flow of information onboard the ship. As the Comms Officer you open channels between relevant crew members, hail other ships, receive messages, relay combat directives etc. As a Comms Officer, you can take the following actions while at your station on the ship:
